...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(ArenaConfig = new(conn));
            AddTable(Circle = new(conn));
            AddTable(PhysicsTimer = new(conn));
        }
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "add_circle" => BSATNHelpers.Decode<Reducer.AddCircle>(encodedArgs),
                "add_circles" => BSATNHelpers.Decode<Reducer.AddCircles>(encodedArgs),
                ...
                "set_arena_size" => BSATNHelpers.Decode<Reducer.SetArenaSize>(encodedArgs),
                "simulate_physics" => BSATNHelpers.Decode<Reducer.SimulatePhysics>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.AddCircle args => Reducers.InvokeAddCircle(eventContext, args),
                Reducer.AddCircles args => Reducers.InvokeAddCircles(eventContext, args),
                ...
                Reducer.SetArenaSize args => Reducers.InvokeSetArenaSize(eventContext, args),
                Reducer.SimulatePhysics args => Reducers.InvokeSimulatePhysics(eventContext, args),
